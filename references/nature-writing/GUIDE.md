...
| File | Open when |
|---|---|
| [article-architecture.md](article-architecture.md) | You need section-level structure, argument order, or published-article writing patterns |
| [abstract.md](abstract.md) | Drafting or revising an abstract, especially challenge-contribution and challenge-insight-contribution forms |
| [introduction.md](introduction.md) | Drafting or revising an Introduction, task framing, technical challenge, contribution framing, or teaser/pipeline logic |
| [related-work.md](related-work.md) | Rebuilding Related Work as topic synthesis instead of a paper-by-paper list |
| —（Method / Experiments 指南未随 scholar 分发） | 写作 Method / Experiments 时按 [article-architecture.md](article-architecture.md) 与 [introduction.md](introduction.md) 的结构与论证链自行组织 |

| [conclusion.md](conclusion.md) | Writing a bounded conclusion with contribution, evidence, impact, limitation, and future direction |
| [paragraph-flow.md](paragraph-flow.md) | User asks whether a paragraph flows, makes sense, or is clear; use reverse outlining and paragraph-message checks |
| [paper-review.md](paper-review.md) | Final manuscript self-review, rejection-risk audit, claim-evidence alignment, or reviewer-facing critique |
| [chinese-author-workflow.md](chinese-author-workflow.md) | The user's notes are Chinese, mixed Chinese-English, or organized as lab notes rather than manuscript prose |
| （示例合集：未随 scholar 分发，不读取；按本文件结构自行组织） | You need concrete abstract, introduction, or method examples after choosing the relevant guide |
...
2. Choose the section architecture from `article-architecture.md`.
...
For method-heavy papers, open `introduction.md` and reason backward
...
For ML/conference-style experiment sections, reason the experiment structure from [article-architecture.md](article-architecture.md)（experiments 指南未随 scholar 分发，不读取）
